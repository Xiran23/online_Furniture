    ...
    <nav> 
        ...
        <div class="menu">
            <ul>
                ...
                <li class="nav-items dropdown"><a href="#">About us </a>
                <ul>
                ...
                <li class="nav-items dropdown"><a href="#">Contact us </a>
                ...
                <li class="nav-items dropdown"><a href="#">Product </a>
...
<div style="display: flex;  justify-content: space-between; margin: auto; width:90%;">
  ...
  <div style="border: 1px solid #ccc; padding: 10px; width: 150px;">
    ...
    <a href="#" style="background-color: blue; color: white; padding: 8px 16px; border: none; border-radius: 4px; font-size: 16px;">Add to Cart</a>
  </div>
...
<div style="display: flex;  justify-content: space-between; margin: auto; margin-top: 10px; width:90%;">
